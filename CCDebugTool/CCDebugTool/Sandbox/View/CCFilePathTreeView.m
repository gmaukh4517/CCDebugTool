...
{
    SandboxEntity *entity = self.pathNodeArray[indexPath.row];
...
{
    SandboxCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"SandboxCollectionViewCellIdentifer" forIndexPath:indexPath];
...
- (UICollectionView *)filePathCollectionView
{
    if (!_filePathCollectionView) {
        ...
        [collectionView registerClass:[SandboxCollectionViewCell class] forCellWithReuseIdentifier:@"SandboxCollectionViewCellIdentifer"];
