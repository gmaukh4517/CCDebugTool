...
/// Error code specific to CCDebugKeychain that can be returned in NSError objects.
/// For codes returned by the operating system, refer to SecBase.h for your
/// platform.
typedef NS_ENUM(OSStatus, CCDebugKeychainErrorCode) {
    /// Some of the arguments were invalid.
    CCDebugKeychainErrorBadArguments = -1001,
};

/// CCDebugKeychain error domain
extern NSString *const kCCDebugKeychainErrorDomain;

/// Account name.
extern NSString *const kCCDebugKeychainAccountKey;

/// Time the item was created.
///
/// The value will be a string.
extern NSString *const kCCDebugKeychainCreatedAtKey;

/// Item class.
extern NSString *const kCCDebugKeychainClassKey;

/// Item description.
extern NSString *const kCCDebugKeychainDescriptionKey;

/// Item label.
extern NSString *const kCCDebugKeychainLabelKey;

/// Time the item was last modified.
///
/// The value will be a string.
extern NSString *const kCCDebugKeychainLastModifiedKey;

/// Where the item was created.
extern NSString *const kCCDebugKeychainWhereKey;
...
@interface CCDebugKeychain : NSObject
...
///
/// @note See the `NSString` constants declared in CCDebugKeychain.h for a list of keys that
