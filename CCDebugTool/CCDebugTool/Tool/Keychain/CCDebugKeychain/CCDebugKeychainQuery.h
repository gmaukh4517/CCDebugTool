...
#define CCDebugKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
// Keychain access group available at compile time
#define CCDebugKEYCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef CCDebugKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, CCDebugKeychainQuerySynchronizationMode) {
    CCDebugKeychainQuerySynchronizationModeAny,
    CCDebugKeychainQuerySynchronizationModeNo,
    CCDebugKeychainQuerySynchronizationModeYes
};
#endif

/// Simple interface for querying or modifying keychain items.
@interface CCDebugKeychainQuery : NSObject
...
@property (nonatomic) CCDebugKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/// The #define CCDebugKEYCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time.
